package org.dawnoftime.gardentrails.worldgen.feature;
...
public class GTFeature extends Feature<SimpleBlockConfiguration> {
    public GTFeature(Codec<SimpleBlockConfiguration> pCodec) {
        super(pCodec);
    }
